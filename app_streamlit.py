"""
Case Study Streamlit App - see README.md for details
"""
...
analyze_pred = importlib.import_module("predictresult")

### SELECTED MODEL ###
st.session_state.runid = "9afdccede6a34025b9a86cf8e5bd4a67"
